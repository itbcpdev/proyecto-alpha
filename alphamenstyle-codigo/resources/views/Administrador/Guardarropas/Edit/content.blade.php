    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h4 class="h2 mb-3">Editar Guardarropa</h4>
                <form action="{{ route('admin.guardarropas.update', ['id' => $guardarropa->id]) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $guardarropa->nombre }}" name="nombre"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="{{ $guardarropa->link }}" name="link"
                                    id="link" placeholder="https://www...">
                            </div>
                            <div class="form-group">
                                <label>Foto</label>
                    ...
                    <a href="{{ route('admin.guardarropas.index') }}" class="btn btn-danger">Volver</a>
                </form>
            </div>
        </div>
    </div>
