    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h4 class="h2 mb-3">Crear Silueta</h4>
                <form action="{{ route('admin.siluetas.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <a href="{{ route('admin.siluetas.index') }}" class="btn btn-danger">Cancelar</a>
                </form>
            </div>
        </div>
    </div>
