    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h4 class="h2 mb-3">Editar Edad</h4>
                <form action="{{ route('admin.edades.update', ['id' => $edad->id]) }}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <a href="{{ route('admin.edades.index') }}" class="btn btn-danger">Volver</a>
                </form>
            </div>
        </div>
    </div>
