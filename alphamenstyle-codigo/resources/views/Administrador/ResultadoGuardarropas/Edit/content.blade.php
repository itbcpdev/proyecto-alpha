    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h4 class="h2 mb-3">Editar Resultado Guardarropa</h4>
                <form action="{{ route('admin.resultado-guardarropas.update', ['id' => $resultados_guardarropa->id]) }}"  method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre" id="nombre" value="{{ $resultados_guardarropa->nombre }}" placeholder="Name">
                                @error('nombre')
                                ...
                                <div class="">
                                    <select class="form-select" multiple aria-label="multiple select example" id="grupoguardarropa"
                                        ...
                                        @foreach ($prendas as $prenda)
                                            <option value="{{ $prenda->id }}">{{ $prenda->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ asset('assets/modules/looks/image/' . $resultados_guardarropa->url_imagen) }}" class="d-block"
