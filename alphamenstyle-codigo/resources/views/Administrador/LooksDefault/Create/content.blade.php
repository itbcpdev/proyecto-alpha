    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h4 class="h2 mb-3">Crear Look por defecto</h4>
                <form action="{{ route('admin.looks-by-default.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <a href="{{ route('admin.looks-by-default.index') }}" class="btn btn-danger">Cancelar</a>
                </form>
            </div>
        </div>
    </div>
