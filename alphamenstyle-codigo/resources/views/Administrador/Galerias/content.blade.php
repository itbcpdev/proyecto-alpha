<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title"> Lista de Galerias </h3>
        <nav aria-label="breadcrumb">
            <a href="{{ route('admin.galerias.create') }}" class="btn btn-block btn-lg btn-success mt-4">Crear Galeria</a>
        </nav>
    </div>
    <div class="row">
                        ...
                        <tbody>
                            @forelse ($galerias as $galeria)
                                <tr>
                                    ...
                                    <td> <img src="{{ asset('assets/modules/galeria/image/' . $galeria->imagen_url) }}"
                                            width="140" style="border-radius: unset;" alt="">
                                    </td>
                                    <td>
                                        <a class="btn btn-success"
                                            href="{{ route('admin.galerias.edit', ['id' => $galeria->id]) }}">
                                            <span class="mr-2">
                                        ...
                                        <a class="btn btn-danger"
                                            href="{{ route('admin.galerias.delete', ['id' => $galeria->id]) }}">
                                            <span class="mr-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
